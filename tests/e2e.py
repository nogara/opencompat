...
def register_tests(suite: TestSuite) -> None:
    ...
    def _(s: TestSuite):
        """Expected models are present (with chatgpt/ prefix)."""
        models = s.client.models.list()
    ...
    def _(s: TestSuite):
        """chatgpt/gpt-5.1-codex model works."""
        r = s.client.chat.completions.create(
            model="chatgpt/gpt-5.1-codex",
            messages=[{"role": "user", "content": "Say 'ok'"}],
        )
        s.assert_is_not_none(r.choices, "chatgpt/gpt-5.1-codex should work")

    @suite.test("model_gpt_5_1_codex_max", "models")
    def _(s: TestSuite):
        """chatgpt/gpt-5.1-codex-max model works."""
        r = s.client.chat.completions.create(
            model="chatgpt/gpt-5.1-codex-max",
            messages=[{"role": "user", "content": "Say 'ok'"}],
        )
        s.assert_is_not_none(r.choices, "chatgpt/gpt-5.1-codex-max should work")

    @suite.test("model_gpt_5_2_codex", "models")
    def _(s: TestSuite):
        """chatgpt/gpt-5.2-codex model works."""
        r = s.client.chat.completions.create(
            model="chatgpt/gpt-5.2-codex",
            messages=[{"role": "user", "content": "Say 'ok'"}],
        )
        s.assert_is_not_none(r.choices, "chatgpt/gpt-5.2-codex should work")

    @suite.test("model_gpt_5", "models")
    def _(s: TestSuite):
        """chatgpt/gpt-5 model works."""
        r = s.client.chat.completions.create(
            model="chatgpt/gpt-5",
            messages=[{"role": "user", "content": "Say 'ok'"}],
        )
        s.assert_is_not_none(r.choices, "chatgpt/gpt-5 should work")

    @suite.test("model_effort_suffix_high", "models")
    def _(s: TestSuite):
        """'chatgpt/gpt-5.1-codex-high' effort suffix works."""
        r = s.client.chat.completions.create(
    ...
    def _(s: TestSuite):
        """'chatgpt/gpt-5.1-codex-low' effort suffix works."""
        r = s.client.chat.completions.create(
            model="chatgpt/gpt-5.1-codex-low",
            messages=[{"role": "user", "content": "Say 'ok'"}],
        )
        s.assert_is_not_none(r.choices, "Effort suffix should work")
    ...
    def _(s: TestSuite):
        ...
        r = requests.post(
            ...
            json={
                "model": "gpt-5.1-codex",  # Missing chatgpt/ prefix
                "messages": [{"role": "user", "content": "Hi"}],
            },
            timeout=s.timeout,
        )
    ...
    def _(s: TestSuite):
        ...
        try:
            s.client.chat.completions.create(
                model="chatgpt/invalid-model-xyz",
                messages=[{"role": "user", "content": "Hi"}],
            )
    ...
    def _(s: TestSuite):
        ...
        r = requests.post(
            f"{s.base_url}/v1/chat/completions",
            json={
                "model": "chatgpt/nonexistent-model-xyz",
                "messages": [{"role": "user", "content": "Hi"}],
            },
            timeout=s.timeout,
        )
    ...
    def _(s: TestSuite):
        ...
        r = requests.post(
            f"{s.base_url}/v1/chat/completions",
            json={"model": "chatgpt/gpt-5.1-codex"},
            timeout=s.timeout,
        )
    ...
    def _(s: TestSuite):
        ...
        r = requests.post(
            f"{s.base_url}/v1/chat/completions",
            json={"model": "chatgpt/gpt-5.1-codex", "messages": []},
            timeout=s.timeout,
        )
